...
export default defineConfig({
  ...
  /* Opt out of parallel tests on CI; cap local workers — five browser
     projects at full parallelism oversubscribe the machine and produce
     load-flakes unrelated to the app. */
